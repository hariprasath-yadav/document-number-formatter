...
console.log(formatDocumentNumber('[D]/[DD]/[dd]/[ddd]/[W]'))
...
| Calendar | Day | Eg. 1: [dd] | SA | It will return current week day |
||| Eg. 2: [ddd] or [DDD] | SAT | It will return current week day |
